...
make_mcts_params! {
    ...
    tm_optscale_value1: f64 = 1.25, 0.1, 2.0, 0.125, 0.002;
    tm_optscale_value2: f64 = 2.5, 0.1, 5.0, 0.25, 0.002;
    tm_optscale_value3: f64 = 0.50, 0.1, 1.0, 0.05, 0.002;
    tm_optscale_value4: f64 = 0.25, 0.1, 1.0, 0.025, 0.002;
    tm_max_value1: f64 = 3.39, 1.0, 10.0, 0.3, 0.002;
    tm_max_value2: f64 = 3.01, 1.0, 10.0, 0.3, 0.002;
    tm_max_value3: f64 = 2.93, 1.0, 10.0, 0.3, 0.002;
    tm_maxscale_value1: f64 = 12.0, 1.0, 24.0, 1.2, 0.002;
    tm_maxscale_value2: f64 = 4.00, 1.0, 12.0, 0.6, 0.002;
    ...
    tm_falling_eval1: f32 = 0.05, 0.0, 0.2, 0.005, 0.002;
    tm_falling_eval2: f32 = 0.60, 0.1, 1.0, 0.06, 0.002;
    tm_falling_eval3: f32 = 1.80, 0.1, 3.0, 0.18, 0.002;
    tm_bmi1: f32 = 0.30, 0.1, 1.0, 0.04, 0.002;
    tm_bmi2: f32 = 1.0, 0.1, 2.0, 0.1, 0.002;
    tm_bmi3: f32 = 3.2, 0.1, 6.4, 0.3, 0.002;
    tm_bmv1: f32 = 2.5, 0.1, 5.0, 0.25, 0.002;
    tm_bmv2: f32 = 0.3, 0.1, 1.0, 0.03, 0.002;
    tm_bmv3: f32 = 0.55, 0.1, 1.0, 0.055, 0.002;
    tm_bmv4: f32 = 4.0, 0.1, 8.0, 0.4, 0.002;
    tm_bmv5: f32 = 0.55, 0.1, 1.0, 0.06, 0.002;
    tm_bmv6: f32 = 1.50, 0.1, 3.0, 0.15, 0.002;
}
