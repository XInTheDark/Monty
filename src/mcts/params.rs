...
make_mcts_params! {
    ...
    tm_opt_value1: f64 = 0.505, 0.1, 1.0, 0.05, 0.002;
    tm_opt_value2: f64 = 0.307, 0.1, 1.0, 0.03, 0.002;
    tm_opt_value3: f64 = 0.635, 0.1, 1.0, 0.06, 0.002;
    tm_optscale_value1: f64 = 1.234, 0.1, 2.0, 0.125, 0.002;
    tm_optscale_value2: f64 = 2.485, 0.1, 5.0, 0.25, 0.002;
    tm_optscale_value3: f64 = 0.557, 0.1, 1.0, 0.05, 0.002;
    tm_optscale_value4: f64 = 0.253, 0.1, 1.0, 0.025, 0.002;
    tm_max_value1: f64 = 3.574, 1.0, 10.0, 0.3, 0.002;
    tm_max_value2: f64 = 2.812, 1.0, 10.0, 0.3, 0.002;
    tm_max_value3: f64 = 2.991, 1.0, 10.0, 0.3, 0.002;
    tm_maxscale_value1: f64 = 12.169, 1.0, 24.0, 1.2, 0.002;
    tm_maxscale_value2: f64 = 3.267, 1.0, 12.0, 0.6, 0.002;
    tm_bonus_ply: f64 = 10.315, 1.0, 30.0, 1.5, 0.002;
    tm_bonus_value1: f64 = 0.496, 0.1, 2.0, 0.05, 0.002;
    tm_max_time: f64 = 0.896, 0.400, 0.990, 0.085, 0.002;
    tm_mtg: i32 = 29, 10, 60, 3, 0.002;
    tm_falling_eval1: f32 = 0.051, 0.0, 0.2, 0.005, 0.002;
    tm_falling_eval2: f32 = 0.623, 0.1, 1.0, 0.06, 0.002;
    tm_falling_eval3: f32 = 1.775, 0.1, 3.0, 0.18, 0.002;
    tm_bmi1: f32 = 0.325, 0.1, 1.0, 0.04, 0.002;
    tm_bmi2: f32 = 0.932, 0.1, 2.0, 0.1, 0.002;
    tm_bmi3: f32 = 3.034, 0.1, 6.4, 0.3, 0.002;
    tm_bmv1: f32 = 2.779, 0.1, 5.0, 0.25, 0.002;
    tm_bmv2: f32 = 0.294, 0.1, 1.0, 0.03, 0.002;
    tm_bmv3: f32 = 0.528, 0.1, 1.0, 0.055, 0.002;
    tm_bmv4: f32 = 3.630, 0.1, 8.0, 0.4, 0.002;
    tm_bmv5: f32 = 0.517, 0.1, 1.0, 0.06, 0.002;
    tm_bmv6: f32 = 1.541, 0.1, 3.0, 0.15, 0.002;
}
